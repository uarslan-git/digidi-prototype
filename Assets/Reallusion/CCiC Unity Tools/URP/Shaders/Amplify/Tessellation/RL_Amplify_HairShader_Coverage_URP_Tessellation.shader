	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float3 Binormal5_g982 = ( ( input.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				...
				float3 bakedGI53_g981 = ASEIndirectDiffuse( input.lightmapUVOrVertexSH.xy, worldNormal86_g981);
...
ASEEND*/
//CHKSM=592C3AB7BFA326E28F2CC7DCCA5DC35F5206F868