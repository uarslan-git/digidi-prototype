	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float3 Binormal5_g986 = ( ( input.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				...
				float3 bakedGI53_g985 = ASEIndirectDiffuse( input.lightmapUVOrVertexSH.xy, worldNormal86_g985);
...
ASEEND*/
//CHKSM=7D5D7ADA1A525A1509CCE2FDA306DD639E9CC3C4