	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				half3 Binormal5_g1088 = ( ( input.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				...
				float2 uv_MaskMap = input.ase_texcoord4.xy * _MaskMap_ST.xy + _MaskMap_ST.zw;
				...
				float2 uv_SpecularMap = input.ase_texcoord4.xy * _SpecularMap_ST.xy + _SpecularMap_ST.zw;
				...
				float2 uv_BlendMap = input.ase_texcoord4.xy * _BlendMap_ST.xy + _BlendMap_ST.zw;
				...
				float2 uv_RootMap = input.ase_texcoord4.xy * _RootMap_ST.xy + _RootMap_ST.zw;
				...
				half3 bakedGI53_g1087 = ASEIndirectDiffuse( input.lightmapUVOrVertexSH.xy, worldNormal86_g1087);
...
ASEEND*/
//CHKSM=DFAB89D4A043CE988758899ECA75680A78869644