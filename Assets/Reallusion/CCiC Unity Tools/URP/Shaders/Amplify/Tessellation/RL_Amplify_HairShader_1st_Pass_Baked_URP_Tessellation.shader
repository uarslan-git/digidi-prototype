	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				half3 Binormal5_g860 = ( ( input.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				...
				half3 bakedGI53_g859 = ASEIndirectDiffuse( input.lightmapUVOrVertexSH.xy, worldNormal86_g859);
...
ASEEND*/
//CHKSM=B8C0BA35C6D43672740C65559DE8DCB05DC9EFBB