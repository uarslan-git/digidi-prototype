	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				half3 Binormal5_g1151 = ( ( input.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				...
				half3 bakedGI53_g1150 = ASEIndirectDiffuse( input.lightmapUVOrVertexSH.xy, worldNormal86_g1150);
...
ASEEND*/
//CHKSM=FBF71DEA0AF2312FB20F30B53BDB61B57AAFE443