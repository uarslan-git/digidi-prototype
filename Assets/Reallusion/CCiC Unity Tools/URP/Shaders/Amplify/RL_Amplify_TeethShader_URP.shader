	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_GumsMaskMap = input.ase_texcoord9.xy * _GumsMaskMap_ST.xy + _GumsMaskMap_ST.zw;
				...
				float2 uv_GradientAOMap = input.ase_texcoord9.xy * _GradientAOMap_ST.xy + _GradientAOMap_ST.zw;
				...
				half2 texCoord77 = input.ase_texcoord9.xy * temp_cast_2 + float2( 0,0 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				half3 hsvTorgb96 = RGBToHSV( tex2DNode32.rgb );
				half3 hsvTorgb99 = HSVToRGB( half3(hsvTorgb96.x,( _TeethSaturation * hsvTorgb96.y ),( hsvTorgb96.z * _TeethBrightness )) );
				float2 uv_GumsMaskMap = input.ase_texcoord4.xy * _GumsMaskMap_ST.xy + _GumsMaskMap_ST.zw;
				half4 tex2DNode103 = SAMPLE_TEXTURE2D( _GumsMaskMap, sampler_GumsMaskMap, uv_GumsMaskMap );
				half3 lerpResult101 = lerp( hsvTorgb36 , hsvTorgb99 , tex2DNode103.g);
				float2 uv_GradientAOMap = input.ase_texcoord4.xy * _GradientAOMap_ST.xy + _GradientAOMap_ST.zw;
				half4 tex2DNode31 = SAMPLE_TEXTURE2D( _GradientAOMap, sampler_GradientAOMap, uv_GradientAOMap );
				half lerpResult132 = lerp( tex2DNode31.r , tex2DNode31.g , _IsUpperTeeth);
				half3 lerpResult40 = lerp( ( _RearAO * lerpResult101 ) , ( lerpResult101 * _FrontAO ) , lerpResult132);
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				half3 hsvTorgb96 = RGBToHSV( tex2DNode32.rgb );
				half3 hsvTorgb99 = HSVToRGB( half3(hsvTorgb96.x,( _TeethSaturation * hsvTorgb96.y ),( hsvTorgb96.z * _TeethBrightness )) );
				float2 uv_GumsMaskMap = input.ase_texcoord2.xy * _GumsMaskMap_ST.xy + _GumsMaskMap_ST.zw;
				half4 tex2DNode103 = SAMPLE_TEXTURE2D( _GumsMaskMap, sampler_GumsMaskMap, uv_GumsMaskMap );
				half3 lerpResult101 = lerp( hsvTorgb36 , hsvTorgb99 , tex2DNode103.g);
				float2 uv_GradientAOMap = input.ase_texcoord2.xy * _GradientAOMap_ST.xy + _GradientAOMap_ST.zw;
				half4 tex2DNode31 = SAMPLE_TEXTURE2D( _GradientAOMap, sampler_GradientAOMap, uv_GradientAOMap );
				half lerpResult132 = lerp( tex2DNode31.r , tex2DNode31.g , _IsUpperTeeth);
				half3 lerpResult40 = lerp( ( _RearAO * lerpResult101 ) , ( lerpResult101 * _FrontAO ) , lerpResult132);
		...
		Pass
		{
						 ...
						 )
			{
				...
				half2 texCoord77 = input.ase_texcoord5.xy * temp_cast_0 + float2( 0,0 );
				half3 unpack76 = UnpackNormalScale( SAMPLE_TEXTURE2D( _MicroNormalMap, sampler_MicroNormalMap, texCoord77 ), _MicroNormalStrength );
				unpack76.z = lerp( 1, unpack76.z, saturate(_MicroNormalStrength) );
...
ASEEND*/
//CHKSM=757B2A3F933C3EB8425EFFFB3AB95ABCE9D3AA81