	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_DiffuseMap = input.ase_texcoord9.xy * _DiffuseMap_ST.xy + _DiffuseMap_ST.zw;
				...
				float2 uv_WrinkleDiffuseBlend1 = input.ase_texcoord9.xy * _WrinkleDiffuseBlend1_ST.xy + _WrinkleDiffuseBlend1_ST.zw;
				float2 uv_WrinkleFlowMap1 = input.ase_texcoord9.xy * _WrinkleFlowMap1_ST.xy + _WrinkleFlowMap1_ST.zw;
				half2 texCoord10_g112 = input.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 uv_WrinkleMaskSet123 = input.ase_texcoord9.xy * _WrinkleMaskSet123_ST.xy + _WrinkleMaskSet123_ST.zw;
				...
				float2 uv_WrinkleMaskSet1A = input.ase_texcoord9.xy * _WrinkleMaskSet1A_ST.xy + _WrinkleMaskSet1A_ST.zw;
				...
				float2 uv_WrinkleMaskSet1B = input.ase_texcoord9.xy * _WrinkleMaskSet1B_ST.xy + _WrinkleMaskSet1B_ST.zw;
				...
				float2 uv_WrinkleDiffuseBlend2 = input.ase_texcoord9.xy * _WrinkleDiffuseBlend2_ST.xy + _WrinkleDiffuseBlend2_ST.zw;
				float2 uv_WrinkleFlowMap2 = input.ase_texcoord9.xy * _WrinkleFlowMap2_ST.xy + _WrinkleFlowMap2_ST.zw;
				...
				float2 uv_WrinkleMaskSet2 = input.ase_texcoord9.xy * _WrinkleMaskSet2_ST.xy + _WrinkleMaskSet2_ST.zw;
				...
				float2 uv_WrinkleDiffuseBlend3 = input.ase_texcoord9.xy * _WrinkleDiffuseBlend3_ST.xy + _WrinkleDiffuseBlend3_ST.zw;
				float2 uv_WrinkleFlowMap3 = input.ase_texcoord9.xy * _WrinkleFlowMap3_ST.xy + _WrinkleFlowMap3_ST.zw;
				...
				float2 uv_WrinkleMaskSet3 = input.ase_texcoord9.xy * _WrinkleMaskSet3_ST.xy + _WrinkleMaskSet3_ST.zw;
				...
				float2 uv_ColorBlendMap = input.ase_texcoord9.xy * _ColorBlendMap_ST.xy + _ColorBlendMap_ST.zw;
				...
				float2 uv_MNAOMap = input.ase_texcoord9.xy * _MNAOMap_ST.xy + _MNAOMap_ST.zw;
				...
				float2 uv_WrinkleNormalBlend1 = input.ase_texcoord9.xy * _WrinkleNormalBlend1_ST.xy + _WrinkleNormalBlend1_ST.zw;
				...
				float2 uv_WrinkleNormalBlend2 = input.ase_texcoord9.xy * _WrinkleNormalBlend2_ST.xy + _WrinkleNormalBlend2_ST.zw;
				...
				float2 uv_WrinkleNormalBlend3 = input.ase_texcoord9.xy * _WrinkleNormalBlend3_ST.xy + _WrinkleNormalBlend3_ST.zw;
				...
				#endif
				float2 uv_NormalBlendMap = input.ase_texcoord9.xy * _NormalBlendMap_ST.xy + _NormalBlendMap_ST.zw;
				float2 uv_SSSMap = input.ase_texcoord9.xy * _SSSMap_ST.xy + _SSSMap_ST.zw;
				half localSkinMask179 = ( 0.0 );
				float2 uv_RGBAMask = input.ase_texcoord9.xy * _RGBAMask_ST.xy + _RGBAMask_ST.zw;
				...
				float2 uv_CFULCMask = input.ase_texcoord9.xy * _CFULCMask_ST.xy + _CFULCMask_ST.zw;
				half4 In2156 = SAMPLE_TEXTURE2D( _CFULCMask, sampler_Linear_Repeat, uv_CFULCMask );
				float2 uv_EarNeckMask = input.ase_texcoord9.xy * _EarNeckMask_ST.xy + _EarNeckMask_ST.zw;
				...
				half2 texCoord308 = input.ase_texcoord9.xy * temp_cast_15 + float2( 0,0 );
				float2 uv_MaskMap = input.ase_texcoord9.xy * _MaskMap_ST.xy + _MaskMap_ST.zw;
				...
				float2 uv_EmissionMap = input.ase_texcoord9.xy * _EmissionMap_ST.xy + _EmissionMap_ST.zw;
				...
				float2 uv_WrinkleRoughnessBlend1 = input.ase_texcoord9.xy * _WrinkleRoughnessBlend1_ST.xy + _WrinkleRoughnessBlend1_ST.zw;
				...
				float2 uv_WrinkleRoughnessBlend2 = input.ase_texcoord9.xy * _WrinkleRoughnessBlend2_ST.xy + _WrinkleRoughnessBlend2_ST.zw;
				...
				float2 uv_WrinkleRoughnessBlend3 = input.ase_texcoord9.xy * _WrinkleRoughnessBlend3_ST.xy + _WrinkleRoughnessBlend3_ST.zw;
				...
				float2 uv_ThicknessMap = input.ase_texcoord9.xy * _ThicknessMap_ST.xy + _ThicknessMap_ST.zw;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 uv_DiffuseMap = input.ase_texcoord4.xy * _DiffuseMap_ST.xy + _DiffuseMap_ST.zw;
				half4 diffuseMap368 = SAMPLE_TEXTURE2D( _DiffuseMap, sampler_DiffuseMap, uv_DiffuseMap );
				half4 diffuse184_g112 = diffuseMap368;
				half4 In181_g112 = diffuse184_g112;
				float2 uv_WrinkleDiffuseBlend1 = input.ase_texcoord4.xy * _WrinkleDiffuseBlend1_ST.xy + _WrinkleDiffuseBlend1_ST.zw;
				float2 uv_WrinkleFlowMap1 = input.ase_texcoord4.xy * _WrinkleFlowMap1_ST.xy + _WrinkleFlowMap1_ST.zw;
				half2 texCoord10_g112 = input.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				half temp_output_1_0_g114 = 0.49;
				half leftMask27_g112 = saturate( ( ( texCoord10_g112.x - temp_output_1_0_g114 ) / ( 0.51 - temp_output_1_0_g114 ) ) );
				half4 break107_g112 = _WrinkleValueSet12CL;
				half2 appendResult112_g112 = (half2(break107_g112.x , break107_g112.y));
				float2 uv_WrinkleMaskSet123 = input.ase_texcoord4.xy * _WrinkleMaskSet123_ST.xy + _WrinkleMaskSet123_ST.zw;
				half4 break109_g112 = SAMPLE_TEXTURE2D( _WrinkleMaskSet123, sampler_Linear_Repeat, uv_WrinkleMaskSet123 );
				half2 appendResult115_g112 = (half2(break109_g112.x , break109_g112.y));
				half dotResult121_g112 = dot( appendResult112_g112 , appendResult115_g112 );
				half value1CLeft135_g112 = dotResult121_g112;
				float2 uv_WrinkleMaskSet1A = input.ase_texcoord4.xy * _WrinkleMaskSet1A_ST.xy + _WrinkleMaskSet1A_ST.zw;
				half4 maskSet1A214_g112 = SAMPLE_TEXTURE2D( _WrinkleMaskSet1A, sampler_Linear_Repeat, uv_WrinkleMaskSet1A );
				half dotResult29_g112 = dot( _WrinkleValueSet1AL , maskSet1A214_g112 );
				float2 uv_WrinkleMaskSet1B = input.ase_texcoord4.xy * _WrinkleMaskSet1B_ST.xy + _WrinkleMaskSet1B_ST.zw;
				half4 temp_output_16_0_g112 = SAMPLE_TEXTURE2D( _WrinkleMaskSet1B, sampler_Linear_Repeat, uv_WrinkleMaskSet1B );
				half dotResult35_g112 = dot( _WrinkleValueSet1BL , temp_output_16_0_g112 );
				half dotResult30_g112 = dot( maskSet1A214_g112 , _WrinkleValueSet1AR );
				half dotResult36_g112 = dot( temp_output_16_0_g112 , _WrinkleValueSet1BR );
				...
				half temp_output_23_0_g116 = ( saturate( ( SAMPLE_TEXTURE2D( _WrinkleFlowMap1, sampler_Linear_Repeat, uv_WrinkleFlowMap1 ).g + temp_output_16_0_g116 ) ) * temp_output_16_0_g116 );
				half4 In1181_g112 = ( ( SAMPLE_TEXTURE2D( _WrinkleDiffuseBlend1, sampler_WrinkleDiffuseBlend1, uv_WrinkleDiffuseBlend1 ) - diffuse184_g112 ) * temp_output_23_0_g116 );
				float2 uv_WrinkleDiffuseBlend2 = input.ase_texcoord4.xy * _WrinkleDiffuseBlend2_ST.xy + _WrinkleDiffuseBlend2_ST.zw;
				float2 uv_WrinkleFlowMap2 = input.ase_texcoord4.xy * _WrinkleFlowMap2_ST.xy + _WrinkleFlowMap2_ST.zw;
				half2 appendResult113_g112 = (half2(break107_g112.z , break107_g112.w));
				half2 appendResult114_g112 = (half2(break109_g112.z , break109_g112.w));
				half dotResult123_g112 = dot( appendResult113_g112 , appendResult114_g112 );
				half value2CLeft137_g112 = dotResult123_g112;
				float2 uv_WrinkleMaskSet2 = input.ase_texcoord4.xy * _WrinkleMaskSet2_ST.xy + _WrinkleMaskSet2_ST.zw;
				half4 temp_output_17_0_g112 = SAMPLE_TEXTURE2D( _WrinkleMaskSet2, sampler_Linear_Repeat, uv_WrinkleMaskSet2 );
				half dotResult41_g112 = dot( _WrinkleValueSet2L , temp_output_17_0_g112 );
				half dotResult42_g112 = dot( temp_output_17_0_g112 , _WrinkleValueSet2R );
				half2 appendResult116_g112 = (half2(break108_g112.z , break108_g112.w));
				...
				half temp_output_23_0_g117 = ( saturate( ( SAMPLE_TEXTURE2D( _WrinkleFlowMap2, sampler_Linear_Repeat, uv_WrinkleFlowMap2 ).g + temp_output_16_0_g117 ) ) * temp_output_16_0_g117 );
				half4 In2181_g112 = ( ( SAMPLE_TEXTURE2D( _WrinkleDiffuseBlend2, sampler_WrinkleDiffuseBlend1, uv_WrinkleDiffuseBlend2 ) - diffuse184_g112 ) * temp_output_23_0_g117 );
				float2 uv_WrinkleDiffuseBlend3 = input.ase_texcoord4.xy * _WrinkleDiffuseBlend3_ST.xy + _WrinkleDiffuseBlend3_ST.zw;
				float2 uv_WrinkleFlowMap3 = input.ase_texcoord4.xy * _WrinkleFlowMap3_ST.xy + _WrinkleFlowMap3_ST.zw;
				half4 break211_g112 = _WrinkleValueSetBCCB;
				half valueBCCLeft217_g112 = ( break211_g112.x * maskSet1A214_g112.y );
				half4 break118_g112 = _WrinkleValueSet3DB;
				half2 appendResult120_g112 = (half2(break118_g112.x , break118_g112.y));
				half dotResult127_g112 = dot( appendResult120_g112 , appendResult115_g112 );
				half value3DLeft129_g112 = dotResult127_g112;
				float2 uv_WrinkleMaskSet3 = input.ase_texcoord4.xy * _WrinkleMaskSet3_ST.xy + _WrinkleMaskSet3_ST.zw;
				half4 temp_output_18_0_g112 = SAMPLE_TEXTURE2D( _WrinkleMaskSet3, sampler_Linear_Repeat, uv_WrinkleMaskSet3 );
				half dotResult47_g112 = dot( _WrinkleValueSet3L , temp_output_18_0_g112 );
				half dotResult48_g112 = dot( temp_output_18_0_g112 , _WrinkleValueSet3R );
				half2 appendResult119_g112 = (half2(break118_g112.z , break118_g112.w));
				...
				#endif
				half4 temp_output_339_0 = ( _DiffuseColor * staticSwitch370 );
				float2 uv_ColorBlendMap = input.ase_texcoord4.xy * _ColorBlendMap_ST.xy + _ColorBlendMap_ST.zw;
				half4 blendOpSrc13 = SAMPLE_TEXTURE2D( _ColorBlendMap, sampler_DiffuseMap, uv_ColorBlendMap );
				half4 blendOpDest13 = temp_output_339_0;
				half4 lerpBlendMode13 = lerp(blendOpDest13,(( blendOpDest13 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest13 ) * ( 1.0 - blendOpSrc13 ) ) : ( 2.0 * blendOpDest13 * blendOpSrc13 ) ),_ColorBlendStrength);
				float2 uv_MNAOMap = input.ase_texcoord4.xy * _MNAOMap_ST.xy + _MNAOMap_ST.zw;
				half4 tex2DNode196 = SAMPLE_TEXTURE2D( _MNAOMap, sampler_Linear_Repeat, uv_MNAOMap );
				half saferPower201 = abs( tex2DNode196.g );
				half saferPower202 = abs( tex2DNode196.b );
				half saferPower203 = abs( tex2DNode196.a );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				half4 diffuse184_g112 = diffuseMap368;
				half4 In181_g112 = diffuse184_g112;
				float2 uv_WrinkleDiffuseBlend1 = input.ase_texcoord2.xy * _WrinkleDiffuseBlend1_ST.xy + _WrinkleDiffuseBlend1_ST.zw;
				float2 uv_WrinkleFlowMap1 = input.ase_texcoord2.xy * _WrinkleFlowMap1_ST.xy + _WrinkleFlowMap1_ST.zw;
				half2 texCoord10_g112 = input.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				half temp_output_1_0_g114 = 0.49;
				half leftMask27_g112 = saturate( ( ( texCoord10_g112.x - temp_output_1_0_g114 ) / ( 0.51 - temp_output_1_0_g114 ) ) );
				half4 break107_g112 = _WrinkleValueSet12CL;
				half2 appendResult112_g112 = (half2(break107_g112.x , break107_g112.y));
				float2 uv_WrinkleMaskSet123 = input.ase_texcoord2.xy * _WrinkleMaskSet123_ST.xy + _WrinkleMaskSet123_ST.zw;
				half4 break109_g112 = SAMPLE_TEXTURE2D( _WrinkleMaskSet123, sampler_Linear_Repeat, uv_WrinkleMaskSet123 );
				half2 appendResult115_g112 = (half2(break109_g112.x , break109_g112.y));
				half dotResult121_g112 = dot( appendResult112_g112 , appendResult115_g112 );
				half value1CLeft135_g112 = dotResult121_g112;
				float2 uv_WrinkleMaskSet1A = input.ase_texcoord2.xy * _WrinkleMaskSet1A_ST.xy + _WrinkleMaskSet1A_ST.zw;
				half4 maskSet1A214_g112 = SAMPLE_TEXTURE2D( _WrinkleMaskSet1A, sampler_Linear_Repeat, uv_WrinkleMaskSet1A );
				half dotResult29_g112 = dot( _WrinkleValueSet1AL , maskSet1A214_g112 );
				float2 uv_WrinkleMaskSet1B = input.ase_texcoord2.xy * _WrinkleMaskSet1B_ST.xy + _WrinkleMaskSet1B_ST.zw;
				half4 temp_output_16_0_g112 = SAMPLE_TEXTURE2D( _WrinkleMaskSet1B, sampler_Linear_Repeat, uv_WrinkleMaskSet1B );
				half dotResult35_g112 = dot( _WrinkleValueSet1BL , temp_output_16_0_g112 );
				half dotResult30_g112 = dot( maskSet1A214_g112 , _WrinkleValueSet1AR );
				half dotResult36_g112 = dot( temp_output_16_0_g112 , _WrinkleValueSet1BR );
				...
				half temp_output_23_0_g116 = ( saturate( ( SAMPLE_TEXTURE2D( _WrinkleFlowMap1, sampler_Linear_Repeat, uv_WrinkleFlowMap1 ).g + temp_output_16_0_g116 ) ) * temp_output_16_0_g116 );
				half4 In1181_g112 = ( ( SAMPLE_TEXTURE2D( _WrinkleDiffuseBlend1, sampler_WrinkleDiffuseBlend1, uv_WrinkleDiffuseBlend1 ) - diffuse184_g112 ) * temp_output_23_0_g116 );
				float2 uv_WrinkleDiffuseBlend2 = input.ase_texcoord2.xy * _WrinkleDiffuseBlend2_ST.xy + _WrinkleDiffuseBlend2_ST.zw;
				float2 uv_WrinkleFlowMap2 = input.ase_texcoord2.xy * _WrinkleFlowMap2_ST.xy + _WrinkleFlowMap2_ST.zw;
				half2 appendResult113_g112 = (half2(break107_g112.z , break107_g112.w));
				half2 appendResult114_g112 = (half2(break109_g112.z , break109_g112.w));
				half dotResult123_g112 = dot( appendResult113_g112 , appendResult114_g112 );
				half value2CLeft137_g112 = dotResult123_g112;
				float2 uv_WrinkleMaskSet2 = input.ase_texcoord2.xy * _WrinkleMaskSet2_ST.xy + _WrinkleMaskSet2_ST.zw;
				half4 temp_output_17_0_g112 = SAMPLE_TEXTURE2D( _WrinkleMaskSet2, sampler_Linear_Repeat, uv_WrinkleMaskSet2 );
				half dotResult41_g112 = dot( _WrinkleValueSet2L , temp_output_17_0_g112 );
				half dotResult42_g112 = dot( temp_output_17_0_g112 , _WrinkleValueSet2R );
				half2 appendResult116_g112 = (half2(break108_g112.z , break108_g112.w));
				...
				half temp_output_23_0_g117 = ( saturate( ( SAMPLE_TEXTURE2D( _WrinkleFlowMap2, sampler_Linear_Repeat, uv_WrinkleFlowMap2 ).g + temp_output_16_0_g117 ) ) * temp_output_16_0_g117 );
				half4 In2181_g112 = ( ( SAMPLE_TEXTURE2D( _WrinkleDiffuseBlend2, sampler_WrinkleDiffuseBlend1, uv_WrinkleDiffuseBlend2 ) - diffuse184_g112 ) * temp_output_23_0_g117 );
				float2 uv_WrinkleDiffuseBlend3 = input.ase_texcoord2.xy * _WrinkleDiffuseBlend3_ST.xy + _WrinkleDiffuseBlend3_ST.zw;
				float2 uv_WrinkleFlowMap3 = input.ase_texcoord2.xy * _WrinkleFlowMap3_ST.xy + _WrinkleFlowMap3_ST.zw;
				half4 break211_g112 = _WrinkleValueSetBCCB;
				half valueBCCLeft217_g112 = ( break211_g112.x * maskSet1A214_g112.y );
				half4 break118_g112 = _WrinkleValueSet3DB;
				half2 appendResult120_g112 = (half2(break118_g112.x , break118_g112.y));
				half dotResult127_g112 = dot( appendResult120_g112 , appendResult115_g112 );
				half value3DLeft129_g112 = dotResult127_g112;
				float2 uv_WrinkleMaskSet3 = input.ase_texcoord2.xy * _WrinkleMaskSet3_ST.xy + _WrinkleMaskSet3_ST.zw;
				half4 temp_output_18_0_g112 = SAMPLE_TEXTURE2D( _WrinkleMaskSet3, sampler_Linear_Repeat, uv_WrinkleMaskSet3 );
				half dotResult47_g112 = dot( _WrinkleValueSet3L , temp_output_18_0_g112 );
				half dotResult48_g112 = dot( temp_output_18_0_g112 , _WrinkleValueSet3R );
				half2 appendResult119_g112 = (half2(break118_g112.z , break118_g112.w));
				...
				#endif
				half4 temp_output_339_0 = ( _DiffuseColor * staticSwitch370 );
				float2 uv_ColorBlendMap = input.ase_texcoord2.xy * _ColorBlendMap_ST.xy + _ColorBlendMap_ST.zw;
				half4 blendOpSrc13 = SAMPLE_TEXTURE2D( _ColorBlendMap, sampler_DiffuseMap, uv_ColorBlendMap );
				half4 blendOpDest13 = temp_output_339_0;
				half4 lerpBlendMode13 = lerp(blendOpDest13,(( blendOpDest13 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest13 ) * ( 1.0 - blendOpSrc13 ) ) : ( 2.0 * blendOpDest13 * blendOpSrc13 ) ),_ColorBlendStrength);
				float2 uv_MNAOMap = input.ase_texcoord2.xy * _MNAOMap_ST.xy + _MNAOMap_ST.zw;
				half4 tex2DNode196 = SAMPLE_TEXTURE2D( _MNAOMap, sampler_Linear_Repeat, uv_MNAOMap );
				half saferPower201 = abs( tex2DNode196.g );
				half saferPower202 = abs( tex2DNode196.b );
				half saferPower203 = abs( tex2DNode196.a );
		...
		Pass
		{
						 ...
						 )
			{
				...
				half3 normal186_g112 = normalMap373;
				half3 In183_g112 = normal186_g112;
				float2 uv_WrinkleNormalBlend1 = input.ase_texcoord5.xy * _WrinkleNormalBlend1_ST.xy + _WrinkleNormalBlend1_ST.zw;
				half3 unpack358 = UnpackNormalScale( SAMPLE_TEXTURE2D( _WrinkleNormalBlend1, sampler_WrinkleNormalBlend1, uv_WrinkleNormalBlend1 ), normalMapScale387 );
				unpack358.z = lerp( 1, unpack358.z, saturate(normalMapScale387) );
				float2 uv_WrinkleFlowMap1 = input.ase_texcoord5.xy * _WrinkleFlowMap1_ST.xy + _WrinkleFlowMap1_ST.zw;
				half2 texCoord10_g112 = input.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				half temp_output_1_0_g114 = 0.49;
				half leftMask27_g112 = saturate( ( ( texCoord10_g112.x - temp_output_1_0_g114 ) / ( 0.51 - temp_output_1_0_g114 ) ) );
				half4 break107_g112 = _WrinkleValueSet12CL;
				half2 appendResult112_g112 = (half2(break107_g112.x , break107_g112.y));
				float2 uv_WrinkleMaskSet123 = input.ase_texcoord5.xy * _WrinkleMaskSet123_ST.xy + _WrinkleMaskSet123_ST.zw;
				half4 break109_g112 = SAMPLE_TEXTURE2D( _WrinkleMaskSet123, sampler_Linear_Repeat, uv_WrinkleMaskSet123 );
				half2 appendResult115_g112 = (half2(break109_g112.x , break109_g112.y));
				half dotResult121_g112 = dot( appendResult112_g112 , appendResult115_g112 );
				half value1CLeft135_g112 = dotResult121_g112;
				float2 uv_WrinkleMaskSet1A = input.ase_texcoord5.xy * _WrinkleMaskSet1A_ST.xy + _WrinkleMaskSet1A_ST.zw;
				half4 maskSet1A214_g112 = SAMPLE_TEXTURE2D( _WrinkleMaskSet1A, sampler_Linear_Repeat, uv_WrinkleMaskSet1A );
				half dotResult29_g112 = dot( _WrinkleValueSet1AL , maskSet1A214_g112 );
				float2 uv_WrinkleMaskSet1B = input.ase_texcoord5.xy * _WrinkleMaskSet1B_ST.xy + _WrinkleMaskSet1B_ST.zw;
				half4 temp_output_16_0_g112 = SAMPLE_TEXTURE2D( _WrinkleMaskSet1B, sampler_Linear_Repeat, uv_WrinkleMaskSet1B );
				half dotResult35_g112 = dot( _WrinkleValueSet1BL , temp_output_16_0_g112 );
				half dotResult30_g112 = dot( maskSet1A214_g112 , _WrinkleValueSet1AR );
				half dotResult36_g112 = dot( temp_output_16_0_g112 , _WrinkleValueSet1BR );
				...
				half temp_output_23_0_g116 = ( saturate( ( SAMPLE_TEXTURE2D( _WrinkleFlowMap1, sampler_Linear_Repeat, uv_WrinkleFlowMap1 ).g + temp_output_16_0_g116 ) ) * temp_output_16_0_g116 );
				half3 In1183_g112 = ( ( unpack358 - normal186_g112 ) * temp_output_23_0_g116 );
				float2 uv_WrinkleNormalBlend2 = input.ase_texcoord5.xy * _WrinkleNormalBlend2_ST.xy + _WrinkleNormalBlend2_ST.zw;
				half3 unpack359 = UnpackNormalScale( SAMPLE_TEXTURE2D( _WrinkleNormalBlend2, sampler_WrinkleNormalBlend1, uv_WrinkleNormalBlend2 ), normalMapScale387 );
				unpack359.z = lerp( 1, unpack359.z, saturate(normalMapScale387) );
				float2 uv_WrinkleFlowMap2 = input.ase_texcoord5.xy * _WrinkleFlowMap2_ST.xy + _WrinkleFlowMap2_ST.zw;
				half2 appendResult113_g112 = (half2(break107_g112.z , break107_g112.w));
				half2 appendResult114_g112 = (half2(break109_g112.z , break109_g112.w));
				half dotResult123_g112 = dot( appendResult113_g112 , appendResult114_g112 );
				half value2CLeft137_g112 = dotResult123_g112;
				float2 uv_WrinkleMaskSet2 = input.ase_texcoord5.xy * _WrinkleMaskSet2_ST.xy + _WrinkleMaskSet2_ST.zw;
				half4 temp_output_17_0_g112 = SAMPLE_TEXTURE2D( _WrinkleMaskSet2, sampler_Linear_Repeat, uv_WrinkleMaskSet2 );
				half dotResult41_g112 = dot( _WrinkleValueSet2L , temp_output_17_0_g112 );
				half dotResult42_g112 = dot( temp_output_17_0_g112 , _WrinkleValueSet2R );
				half2 appendResult116_g112 = (half2(break108_g112.z , break108_g112.w));
				...
				half temp_output_23_0_g117 = ( saturate( ( SAMPLE_TEXTURE2D( _WrinkleFlowMap2, sampler_Linear_Repeat, uv_WrinkleFlowMap2 ).g + temp_output_16_0_g117 ) ) * temp_output_16_0_g117 );
				half3 In2183_g112 = ( ( unpack359 - normal186_g112 ) * temp_output_23_0_g117 );
				float2 uv_WrinkleNormalBlend3 = input.ase_texcoord5.xy * _WrinkleNormalBlend3_ST.xy + _WrinkleNormalBlend3_ST.zw;
				half3 unpack360 = UnpackNormalScale( SAMPLE_TEXTURE2D( _WrinkleNormalBlend3, sampler_WrinkleNormalBlend1, uv_WrinkleNormalBlend3 ), normalMapScale387 );
				unpack360.z = lerp( 1, unpack360.z, saturate(normalMapScale387) );
				float2 uv_WrinkleFlowMap3 = input.ase_texcoord5.xy * _WrinkleFlowMap3_ST.xy + _WrinkleFlowMap3_ST.zw;
				half4 break211_g112 = _WrinkleValueSetBCCB;
				half valueBCCLeft217_g112 = ( break211_g112.x * maskSet1A214_g112.y );
				half4 break118_g112 = _WrinkleValueSet3DB;
				half2 appendResult120_g112 = (half2(break118_g112.x , break118_g112.y));
				half dotResult127_g112 = dot( appendResult120_g112 , appendResult115_g112 );
				half value3DLeft129_g112 = dotResult127_g112;
				float2 uv_WrinkleMaskSet3 = input.ase_texcoord5.xy * _WrinkleMaskSet3_ST.xy + _WrinkleMaskSet3_ST.zw;
				half4 temp_output_18_0_g112 = SAMPLE_TEXTURE2D( _WrinkleMaskSet3, sampler_Linear_Repeat, uv_WrinkleMaskSet3 );
				half dotResult47_g112 = dot( _WrinkleValueSet3L , temp_output_18_0_g112 );
				half dotResult48_g112 = dot( temp_output_18_0_g112 , _WrinkleValueSet3R );
				half2 appendResult119_g112 = (half2(break118_g112.z , break118_g112.w));
				...
				half3 staticSwitch372 = normalMap373;
				#endif
				float2 uv_NormalBlendMap = input.ase_texcoord5.xy * _NormalBlendMap_ST.xy + _NormalBlendMap_ST.zw;
				float2 uv_SSSMap = input.ase_texcoord5.xy * _SSSMap_ST.xy + _SSSMap_ST.zw;
				half localSkinMask179 = ( 0.0 );
				float2 uv_RGBAMask = input.ase_texcoord5.xy * _RGBAMask_ST.xy + _RGBAMask_ST.zw;
				half4 tex2DNode123 = SAMPLE_TEXTURE2D( _RGBAMask, sampler_Linear_Repeat, uv_RGBAMask );
				half4 In1179 = tex2DNode123;
				half4 appendResult150 = (half4(_RSmoothnessMod , _GSmoothnessMod , _BSmoothnessMod , _ASmoothnessMod));
				half4 Mod1179 = appendResult150;
				...
				half localHeadMask156 = ( 0.0 );
				half4 In1156 = tex2DNode123;
				float2 uv_CFULCMask = input.ase_texcoord5.xy * _CFULCMask_ST.xy + _CFULCMask_ST.zw;
				half4 In2156 = SAMPLE_TEXTURE2D( _CFULCMask, sampler_Linear_Repeat, uv_CFULCMask );
				float2 uv_EarNeckMask = input.ase_texcoord5.xy * _EarNeckMask_ST.xy + _EarNeckMask_ST.zw;
				half4 In3156 = SAMPLE_TEXTURE2D( _EarNeckMask, sampler_Linear_Repeat, uv_EarNeckMask );
				half4 Mod1156 = appendResult150;
				half4 appendResult151 = (half4(_CheekSmoothnessMod , _ForeheadSmoothnessMod , _UpperLipSmoothnessMod , _ChinSmoothnessMod));
				half4 Mod2156 = appendResult151;
				...
				half2 texCoord308 = input.ase_texcoord5.xy * temp_cast_9 + float2( 0,0 );
...
ASEEND*/
//CHKSM=DE1EDBF0D32D68BBFBAB9E4C7C0C56E517C2428A