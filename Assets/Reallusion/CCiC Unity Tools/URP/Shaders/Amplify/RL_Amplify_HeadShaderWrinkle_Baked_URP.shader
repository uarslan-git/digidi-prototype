	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_WrinkleFlowPack = input.ase_texcoord9.xy * _WrinkleFlowPack_ST.xy + _WrinkleFlowPack_ST.zw;
				half4 tex2DNode258 = SAMPLE_TEXTURE2D( _WrinkleFlowPack, sampler_Linear_Repeat, uv_WrinkleFlowPack );
				half2 texCoord10_g35 = input.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				...
				#endif
				float2 uv_DetailNormalMap = input.ase_texcoord9.xy * _DetailNormalMap_ST.xy + _DetailNormalMap_ST.zw;
				float2 uv_DetailMask = input.ase_texcoord9.xy * _DetailMask_ST.xy + _DetailMask_ST.zw;
				...
				float2 uv_WrinkleSmoothnessPack = input.ase_texcoord9.xy * _WrinkleSmoothnessPack_ST.xy + _WrinkleSmoothnessPack_ST.zw;
				...
				float2 uv_SubsurfaceMaskMap = input.ase_texcoord9.xy * _SubsurfaceMaskMap_ST.xy + _SubsurfaceMaskMap_ST.zw;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 uv_WrinkleFlowPack = input.ase_texcoord4.xy * _WrinkleFlowPack_ST.xy + _WrinkleFlowPack_ST.zw;
				half4 tex2DNode258 = SAMPLE_TEXTURE2D( _WrinkleFlowPack, sampler_Linear_Repeat, uv_WrinkleFlowPack );
				half2 texCoord10_g35 = input.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				half temp_output_1_0_g37 = 0.49;
				half leftMask27_g35 = saturate( ( ( texCoord10_g35.x - temp_output_1_0_g37 ) / ( 0.51 - temp_output_1_0_g37 ) ) );
				half4 break107_g35 = _WrinkleValueSet12CL;
				half2 appendResult112_g35 = (half2(break107_g35.x , break107_g35.y));
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 uv_WrinkleFlowPack = input.ase_texcoord2.xy * _WrinkleFlowPack_ST.xy + _WrinkleFlowPack_ST.zw;
				half4 tex2DNode258 = SAMPLE_TEXTURE2D( _WrinkleFlowPack, sampler_Linear_Repeat, uv_WrinkleFlowPack );
				half2 texCoord10_g35 = input.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				half temp_output_1_0_g37 = 0.49;
				half leftMask27_g35 = saturate( ( ( texCoord10_g35.x - temp_output_1_0_g37 ) / ( 0.51 - temp_output_1_0_g37 ) ) );
				half4 break107_g35 = _WrinkleValueSet12CL;
				half2 appendResult112_g35 = (half2(break107_g35.x , break107_g35.y));
		...
		Pass
		{
						 ...
						 )
			{
				...
				half3 unpack239 = UnpackNormalScale( SAMPLE_TEXTURE2D( _WrinkleNormalBlend1, sampler_BumpMap, uv_WrinkleNormalBlend1 ), normalMapScale260 );
				unpack239.z = lerp( 1, unpack239.z, saturate(normalMapScale260) );
				float2 uv_WrinkleFlowPack = input.ase_texcoord5.xy * _WrinkleFlowPack_ST.xy + _WrinkleFlowPack_ST.zw;
				half4 tex2DNode258 = SAMPLE_TEXTURE2D( _WrinkleFlowPack, sampler_Linear_Repeat, uv_WrinkleFlowPack );
				half2 texCoord10_g35 = input.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				half temp_output_1_0_g37 = 0.49;
				half leftMask27_g35 = saturate( ( ( texCoord10_g35.x - temp_output_1_0_g37 ) / ( 0.51 - temp_output_1_0_g37 ) ) );
				half4 break107_g35 = _WrinkleValueSet12CL;
				half2 appendResult112_g35 = (half2(break107_g35.x , break107_g35.y));
				...
				half3 staticSwitch246 = normalMap206;
				#endif
				float2 uv_DetailNormalMap = input.ase_texcoord5.xy * _DetailNormalMap_ST.xy + _DetailNormalMap_ST.zw;
				float2 uv_DetailMask = input.ase_texcoord5.xy * _DetailMask_ST.xy + _DetailMask_ST.zw;
				half3 unpack148 = UnpackNormalScale( SAMPLE_TEXTURE2D( _DetailNormalMap, sampler_BumpMap, uv_DetailNormalMap ), ( _DetailNormalMapScale * SAMPLE_TEXTURE2D( _DetailMask, sampler_BumpMap, uv_DetailMask ).g ) );
				unpack148.z = lerp( 1, unpack148.z, saturate(( _DetailNormalMapScale * SAMPLE_TEXTURE2D( _DetailMask, sampler_BumpMap, uv_DetailMask ).g )) );
...
ASEEND*/
//CHKSM=BB5ED8A84787CB74E1A75C3EC5686578B5185FC7